...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 bg-[#f7f1e2]">
      <div className="navbar md:container mx-auto bg-[#f7f1e2] pt-2 pb-5">
        ...
        <div className="navbar-end gap-2">
          {user ? (
            ...
            <>
              <NavLink
                to="/auth/login"
                className="btn bg-[#A37854] text-white hover:bg-[#8a623e]"
              >
                LogIn
              </NavLink>
              <NavLink
